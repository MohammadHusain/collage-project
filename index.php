...
<body>
	<div style="background-color: #f0f0f0;;background-image: url(../Images/bgpng1.png);color: #606060;font-size: 12px" class="">
			<center>© 2019 Premium cars & Movies booking Dealer</center>
	</div>
	<nav class="container-fluid pr-0 d-flex" style="">
		...
		<div class="links-container hide" id="">
			<ul class="navbar navbar-links text-light">
				...
				<li class="nav-item " style=""><a href="#Recommand" class="nav-link ">Recommand</a></li>
				<li class="nav-item"><a href="#feedbackContainer" class="nav-link">Feedback</a></li>
			</ul>
		</div>
